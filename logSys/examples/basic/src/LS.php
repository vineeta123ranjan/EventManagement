...
| The vineeta Project                                                      |
| ------------------------------------------------------------------------- |
| This software logSys is a part of the vineeta (Fr) project.              |
| http://subinsb.com/the-vineeta-project                                   |
| ------------------------------------------------------------------------- |
|     Author: Subin Siby                                                    |
...
class LS {
  ...
  /**
   * Log something in the vineeta.log file.
   * To enable logging, make a file called "vineeta.log" in the directory
   * where "class.logsys.php" file is situated
   */
  public static function log($msg = ""){
    $log_file = __DIR__ . "/vineeta.log";
